...
class CategoryTest {
    ...
    void getName() {
        Category ob = new Category();
        ob.setName("Electronics");
        assertEquals("Electronics",ob.getName());
    }
    ...
    void getUser() {
        ...
        exp1.setCategory(cat1);

        Category cat2 = new Category();
        cat2.setId(2);
        cat2.setName("Market");
        cat2.setUser(new User());
        exp2.setCategory(cat2);

        Category cat3 = new Category();
        cat3.setId(3);
        cat3.setName("Luxury");
        cat3.setUser(new User());
        exp3.setCategory(cat3);
        ...
        Category ob = new Category(1, "Luxury", new User());

        assertEquals(cat1.getUser() ,ob.getUser());
    }
}